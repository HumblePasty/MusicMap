;(function () {
  ...
  var each = (helpers.each = function (loopable, callback, self) {
    ...
    findNextWhere = (helpers.findNextWhere = function (
      arrayToSearch,
      filterCallback,
      startIndex
    ) {
    ...
    findPreviousWhere = (helpers.findPreviousWhere = function (
      arrayToSearch,
      filterCallback,
      startIndex
    ) {
    ...
    getAngleFromPoint = (helpers.getAngleFromPoint = function (
      centrePoint,
      anglePoint
    ) {
      ...
      var angle =
        Math.PI * 2 + Math.atan2(distanceFromYCenter, distanceFromXCenter)
    ...
    splineCurve = (helpers.splineCurve = function (
      FirstPoint,
      MiddlePoint,
      AfterPoint,
      t
    ...
    calculateOrderOfMagnitude = (helpers.calculateOrderOfMagnitude = function (
      val
    ) {
    ...
    calculateScaleRange = (helpers.calculateScaleRange = function (
      ...
      while (
        (numberOfSteps > maxSteps || numberOfSteps * 2 < maxSteps) &&
        !skipFitting
      ) {
    ...
    /* jshint ignore:end */
    generateLabels = (helpers.generateLabels = function (
      templateString,
      numberOfSteps,
      graphMin,
      stepValue
    ...
    bindEvents = (helpers.bindEvents = function (
      chartInstance,
      arrayOfEvents,
      handler
    ) {
    ...
    unbindEvents = (helpers.unbindEvents = function (
      chartInstance,
      arrayOfEvents
    ) {
            ...
            medianPosition = function (index) {
              ...
              helpers.each(
                ...
                function (element) {
                  ...
                  tooltipLabels.push(
                    helpers.template(this.options.multiTooltipTemplate, element)
                  )
                  tooltipColors.push({
  ...
  Chart.Scale = Chart.Element.extend({
    ...
    buildYLabels: function () {
      ...
      this.yLabelWidth =
        this.display && this.showLabels
          ? longestText(this.ctx, this.font, this.yLabels)
          : 0
    },
    ...
    fit: function () {
      ...
      this.endPoint = this.display
        ? this.height - this.fontSize * 1.5 - 5
        : this.height // -5 to pad labels
    ...
    calculateXLabelRotation: function () {
      ...
      this.xScalePaddingLeft =
        firstWidth / 2 > this.yLabelWidth + 10
          ? firstWidth / 2
          : this.yLabelWidth + 10
      ...
      if (this.display) {
        ...
        while (
          (this.xLabelWidth > xGridWidth && this.xLabelRotation === 0) ||
        ...
        if (!this.lineArc) {
          ...
          for (var i = this.valuesCount - 1; i >= 0; i--) {
            if (this.angleLineWidth > 0) {
              var outerPosition = this.getPointPosition(
                i,
    ...
    initialize: function (data) {
      ...
      if (this.options.showTooltips) {
        helpers.bindEvents(this, this.options.tooltipEvents, function (evt) {
          var activeBars =
            evt.type !== 'mouseout' ? this.getBarsAtEvent(evt) : []
  ...
  Chart.Type.extend({
    ...
    initialize: function (data) {
      ...
      if (this.options.showTooltips) {
        helpers.bindEvents(this, this.options.tooltipEvents, function (evt) {
          var activeSegments =
            evt.type !== 'mouseout' ? this.getSegmentsAtEvent(evt) : []
  ...
  Chart.Type.extend({
    ...
    initialize: function (data) {
      ...
      if (this.options.showTooltips) {
        helpers.bindEvents(this, this.options.tooltipEvents, function (evt) {
          var activePoints =
            evt.type !== 'mouseout' ? this.getPointsAtEvent(evt) : []
    ...
    getPointsAtEvent: function (evt) {
      ...
      var anglePerIndex = (Math.PI * 2) / this.scale.valuesCount,
        pointIndex = Math.round(
          (fromCenter.angle - Math.PI * 1.5) / anglePerIndex
        ),
